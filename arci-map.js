...
const buildingsData = {
    ...
    "udrzba": { name: "Údržba", x: 8.5, y: 41.0, doorX: 8.5, doorY: 42.0, size: 75, img: "buda_udrzba.png", detail: "mapa-udrzba.png", action: "openSettings" },
    ...
    "chillspot": { name: "Chill Spot", x: 2.0, y: 53.0, doorX: 1.8, doorY: 48.0, size: 110, img: "buda_joint.png", detail: "joint.png", action: "openJointSpot" },
    ...
    "vyhladat": { name: "Vyhľadať Hráča", x: 76.17, y: 87.0, doorX: 76.17, doorY: 88.0, size: 30, img: "buda-vyhladat.png", detail: "mapa_vyhladat.png", action: "openMapSearchModal" }, 
    ...
    "sponsor": { name: "Sponzori", x: 36.1, y: 31.3, doorX: 34.5, doorY: 30.6, size: 115, img: "buda_palac.png", detail: "mapa-sponsor.png", action: "openSponsorInfo" },
