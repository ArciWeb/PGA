...
const buildingsData = {
    ...
    "fedex": { name: "Fedex Rank", x: 63.0, y: 38.5, size: 75, img: "buda_fedex.png", detail: "mapa-fedex.png", action: "showRankTable_FEDEX" },
    ...
    "world": { name: "World Tour Rank", x: 35.9, y: 23.6, size: 105, img: "buda_worldtour.png", detail: "mapa-worldtour.png", action: "showRankTable_Tour" },
    ...
    "stadion": { name: "Rebríček PGA Cards", x: 24.5, y: 63.2, size: 330, img: "buda_stadion.png", detail: "mapa-cards.png", action: "showGlobalPlayerCards" }
