...
const buildingsData = {
    "udrzba": { name: "Údržba", x: 6.5, y: 36.0, size: 75, img: "buda_udrzba.png", detail: "mapa-udrzba.png", action: "openSettings" },
    "kostol": { name: "Kostol", x: 21.5, y: 15.0, size: 95, img: "buda_kostol.png", detail: "mapa-kostol.png", action: "openGameCalendar" },
    "arcibot": { name: "ArciBot", x: 10.5, y: 55.0, size: 35, img: "buda_arcibot.png", detail: "mapa-arcibot.png", action: "openAiAssistant" },
    "osobne": { name: "Osobné úspechy", x: 10.0, y: 78.5, size: 120, img: "buda_zahradka.png", detail: "mapa-personal.png", action: "openPersonalAchievements" },
    ...
    "kniznica": { name: "Knižnica", x: 39.5, y: 41.5, size: 115, img: "buda_kniznica.png", detail: "mapa-hof.png", action: "openHallOfFame" },
    ...
    "fedex": { name: "Fedex Rank", x: 62.0, y: 28.5, size: 75, img: "buda_fedex.png", detail: "mapa-fedex.png", action: "showRankTable_FEDEX" },
