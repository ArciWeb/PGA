...
const buildingsData = {
    ...
    "stadion": { name: "Štadión", x: 22.0, y: 50.0, size: 210, img: "buda_stadion.png", detail: "mapa-cards.png", action: "showGlobalPlayerCards" },
    "banka": { name: "Net Worth Banka", x: 21.5, y: 68.0, size: 105, img: "buda_banka.png", detail: "mapa-bank.png", action: "openNetWorth" },
    ...
    "invest": { name: "ArciInvest", x: 34.0, y: 77.0, size: 115, img: "buda_arciinvest.png", detail: "mapa-invest.png", action: "openArciInvest" },
    "bankomat": { name: "Bankomat", x: 27.5, y: 62.0, size: 70, img: "buda_bankomat.png", detail: "mapa-balance.png", action: "openMyPlayer" },
    ...
    "shop": { name: "ArciShop", x: 44.0, y: 72.0, size: 105, img: "buda_arcishop.png", detail: "mapa-shop.png", action: "openArciShop" },
    ...
    "amateur": { name: "Amateur Rank", x: 87.5, y: 36.0, size: 95, img: "buda_amateur.png", detail: "mapa-amateur.png", action: "showRankTable_Amateur" },
    "plavaren": { name: "Plaváreň", x: 86.0, y: 55.0, size: 110, img: "buda_plavaren.png", detail: "mapa-happy.png", action: "openHappinessOverview" },
